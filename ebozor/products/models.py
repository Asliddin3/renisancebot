...
class Contract(models.Model):
    ...
    fakultet_id=models.IntegerField(verbose_name="fakultet idsi",default=0)
    message_id=models.CharField(verbose_name="Contractni habar id si",max_length=1000,null=True)
    full_name=models.CharField(verbose_name="Toliq ismi sharifi",default="",max_length=200)
    phone=models.CharField(verbose_name="Telefon raqam",max_length=100,default="",unique=True)
    extra_phone=models.CharField(verbose_name="Qoshimcha raqam",max_length=100,default="")
    state=models.CharField(verbose_name="Contract holati",max_length=100,default="registered",choices=ContractState)
    result=models.IntegerField(verbose_name="Togri topilgan javoblar soni",default=0)
    address=models.CharField(verbose_name="Propiska joyi",max_length=1000)
    passport = models.CharField(verbose_name="Passport raqami", max_length=100,unique=True)
